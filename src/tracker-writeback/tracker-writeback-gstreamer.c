                                         ...
                                         GError               **error)
{
	...
	for (l = properties; l; l = l->next) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "performer") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "musicAlbum") == 0) {
			...
			if (album) {
				album_name = tracker_resource_get_first_string (album, TRACKER_PREFIX_NIE "title");
				artist = tracker_resource_get_first_relation (album, TRACKER_PREFIX_NMM "albumArtist");
			}

			if (artist) {
				album_artist = tracker_resource_get_first_string (artist, TRACKER_PREFIX_NMM "artistName");
			}
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "genre") == 0) {
			const gchar *genre;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "trackNumber") == 0) {
			gint number;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "artwork") == 0) {
			...
			if (image)
				file = tracker_resource_get_first_relation (image, TRACKER_PREFIX_NIE "isStoredAs");

			if (file)
				artwork_url = tracker_resource_get_first_string (image, TRACKER_PREFIX_NIE "url");
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "internationalStandardRecordingCode") == 0) {
			const gchar *isrc;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "lyrics") == 0) {
			const gchar *lyrics;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "composer") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "musicAlbumDisc") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NCO "publisher") == 0) {
