                                   ...
                                   GError               **error)
{
	...
	for (l = properties; l; l = l->next) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NIE "title") == 0) {
			const gchar *title;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NCO "creator") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NCO "contributor") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NIE "description") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NIE "copyright") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NIE "comment") == 0) {
			const gchar *comment;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NIE "keyword") == 0) {
			GList *keywords, *k;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NIE "contentCreated") == 0) {
			const gchar *created;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NFO "orientation") == 0) {
			...
			if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-top") == 0) {
				xmp_set_property (xmp, NS_EXIF, "Orientation", "top - left", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-top-mirror") == 0) {
				xmp_set_property (xmp, NS_EXIF, "Orientation", "top - right", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-bottom") == 0) {
				xmp_set_property (xmp, NS_EXIF, "Orientation", "bottom - left", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-bottom-mirror") == 0) {
				xmp_set_property (xmp, NS_EXIF, "Orientation", "bottom - right", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-left-mirror") == 0) {
				xmp_set_property (xmp, NS_EXIF, "Orientation", "left - top", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-right") == 0) {
				xmp_set_property (xmp, NS_EXIF, "Orientation", "right - top", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-right-mirror") == 0) {
					xmp_set_property (xmp, NS_EXIF, "Orientation", "right - bottom", 0);
			} else if (g_strcmp0 (orientation, TRACKER_PREFIX_NFO "orientation-left") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "meteringMode") == 0) {
			...
			if (g_strcmp0 (metering, TRACKER_PREFIX_NMM "metering-mode-center-weighted-average") == 0) {
				xmp_set_property (xmp, NS_EXIF, "MeteringMode", "0", 0);
			} else if (g_strcmp0 (metering, TRACKER_PREFIX_NMM "metering-mode-average") == 0) {
				xmp_set_property (xmp, NS_EXIF, "MeteringMode", "1", 0);
			} else if (g_strcmp0 (metering, TRACKER_PREFIX_NMM "metering-mode-spot") == 0) {
				xmp_set_property (xmp, NS_EXIF, "MeteringMode", "3", 0);
			} else if (g_strcmp0 (metering, TRACKER_PREFIX_NMM "metering-mode-multispot") == 0) {
				xmp_set_property (xmp, NS_EXIF, "MeteringMode", "4", 0);
			} else if (g_strcmp0 (metering, TRACKER_PREFIX_NMM "metering-mode-pattern") == 0) {
				xmp_set_property (xmp, NS_EXIF, "MeteringMode", "5", 0);
			} else if (g_strcmp0 (metering, TRACKER_PREFIX_NMM "metering-mode-partial") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "whiteBalance") == 0) {
			const gchar *balance;
			...
			if (g_strcmp0 (balance, TRACKER_PREFIX_NMM "white-balance-auto") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "flash") == 0) {
			const gchar *flash;
			...
			if (g_strcmp0 (flash, TRACKER_PREFIX_NMM "flash-on") == 0) {
		...
		/* TODO: Don't write value as-is here, read xmp_specification.pdf,
		   page 84 (bottom). */
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "focalLength") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "exposureTime") == 0) {
			gdouble exposure;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "isoSpeed") == 0) {
			gdouble speed;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NMM "fnumber") == 0) {
			gdouble fnumber;
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NFO "equipment") == 0) {
			...
			if (equipment) {
				maker = tracker_resource_get_first_string (equipment,
				                                           TRACKER_PREFIX_NFO "manufacturer");
				model = tracker_resource_get_first_string (equipment,
				                                           TRACKER_PREFIX_NFO "model");
			}
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_NFO "heading") == 0) {
		...
		if (g_strcmp0 (prop, TRACKER_PREFIX_SLO "location") == 0) {
			 ...
			 * used sanely */
			str = tracker_resource_get_first_string (location, TRACKER_PREFIX_NCO "locality");
			...
			str = tracker_resource_get_first_string (location, TRACKER_PREFIX_NCO "region");
			...
			str = tracker_resource_get_first_string (location, TRACKER_PREFIX_NCO "streetAddress");
			...
			str = tracker_resource_get_first_string (location, TRACKER_PREFIX_NCO "country");
			...
			value = tracker_resource_get_first_double (location, TRACKER_PREFIX_SLO "altitude");
			xmp_delete_property (xmp, NS_EXIF, "GPSAltitude");
			g_ascii_dtostr (buf, G_ASCII_DTOSTR_BUF_SIZE, value);
			xmp_set_property (xmp, NS_EXIF, "GPSAltitude", buf, 0);

			value = tracker_resource_get_first_double (location, TRACKER_PREFIX_SLO "longitude");
			write_gps_coord (xmp, "GPSLongitude", value, 'E', 'W');

			value = tracker_resource_get_first_double (location, TRACKER_PREFIX_SLO "latitude");
