...
tracker_extract_get_metadata (TrackerExtractInfo *info)
{
	...
	if (md.mb_recording_id) {
		TrackerResource *mb_recording_id = tracker_extract_new_external_resource("https://musicbrainz.org/doc/Recording",
											 md.mb_recording_id);
	...
	if (md.mb_track_id) {
		TrackerResource *mb_track_id = tracker_extract_new_external_resource("https://musicbrainz.org/doc/Track",
										     md.mb_track_id);
