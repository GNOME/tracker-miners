...
tracker_extract_get_metadata (TrackerExtractInfo *info)
{
	...
	md.mbrecordingid = tracker_coalesce_strip (3, md.id3v24.mbrecordingid,
	                                        md.id3v23.mbrecordingid,
	                                        md.id3v22.mbrecordingid);

	md.mbtrackid = tracker_coalesce_strip (3, md.id3v24.mbtrackid,
	                                        md.id3v23.mbtrackid,
	                                        md.id3v22.mbtrackid);

	md.mbalbumid = tracker_coalesce_strip (3, md.id3v24.mbalbumid,
	                                        md.id3v23.mbalbumid,
	                                        md.id3v22.mbalbumid);

	md.mboriginalalbumid = tracker_coalesce_strip (3, md.id3v24.mboriginalalbumid,
	                                        md.id3v23.mboriginalalbumid,
	                                        md.id3v22.mboriginalalbumid);

	md.mbartistid = tracker_coalesce_strip (3, md.id3v24.mbartistid,
	                                        md.id3v23.mbartistid,
	                                        md.id3v22.mbartistid);

	md.mboriginalartistid = tracker_coalesce_strip (3, md.id3v24.mboriginalartistid,
	                                        md.id3v23.mboriginalartistid,
	                                        md.id3v22.mboriginalartistid);

	md.mbalbumartistid = tracker_coalesce_strip (3, md.id3v24.mbalbumartistid,
	                                        md.id3v23.mbalbumartistid,
	                                        md.id3v22.mbalbumartistid);

	md.mbreleasegroupid = tracker_coalesce_strip (3, md.id3v24.mbreleasegroupid,
	                                        md.id3v23.mbreleasegroupid,
	                                        md.id3v22.mbreleasegroupid);

	md.mbworkid = tracker_coalesce_strip (3, md.id3v24.mbworkid,
	                                        md.id3v23.mbworkid,
	                                        md.id3v22.mbworkid);

	md.mbtrmid = tracker_coalesce_strip (3, md.id3v24.mbtrmid,
	                                        md.id3v23.mbtrmid,
	                                        md.id3v22.mbtrmid);

	md.mbdiscid = tracker_coalesce_strip (3, md.id3v24.mbdiscid,
	                                        md.id3v23.mbdiscid,
	                                        md.id3v22.mbdiscid);
