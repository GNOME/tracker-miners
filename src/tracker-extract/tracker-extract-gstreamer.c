                                  ...
                                  TrackerResource      **p_composer)
{
	...
	*p_performer = NULL;
	...
	set_property_from_gst_tag (resource, "nmm:mbTrackID", tag_list, GST_TAG_MUSICBRAINZ_RELEASETRACKID);
	...
	gst_tag_list_copy_value (&acoustid_fingerprint, tag_list, GST_TAG_CHROMAPRINT_FINGERPRINT);
