...
class FlacCuesheetTest(fixtures.TrackerExtractTestCase):
    def spec(self, audio_path):
        ...
        return {
            ...
            'nmm:musicAlbumDisc': 'urn:album-disc:Loveless:My%20Bloody%20Valentine:Disc1:1991-01-01T00:00:00Z',
            'nie:isStoredAs': {
                '@id': audio_uri,
                'nie:interpretedAs': [
                    audio_uri,
                    {
                        ...
                        'nmm:musicAlbumDisc': {
                            '@id': 'urn:album-disc:Loveless:My%20Bloody%20Valentine:Disc1:1991-01-01T00:00:00Z',
                            'nmm:setNumber': 1,
